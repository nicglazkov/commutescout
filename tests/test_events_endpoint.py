...
# The dedicated closure snap loop (and its _snap_path helper) is gone:
# roadsnap owns closure geometry now, with its own quality gates
# covered in tests/test_roadsnap.py.
